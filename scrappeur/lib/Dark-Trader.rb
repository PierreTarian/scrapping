...
def crypto_path(page)
    crypto_main_path = page.xpath('//*[@id="__next"]/div[2]/div[2]/div/div[1]/div/div[2]/div[3]/div/table/tbody')
 ...
 def symbol_array(crypto_main_path)
    ...
    crypto_main_path.each do |crypto_symbol|
      symbol = crypto_symbol.xpath('/html/body/div[1]/div[2]/div[2]/div/div[1]/div/div[2]/div[3]/div/table/tbody/tr[1]/td[3]').text
...
def price_array(crypto_main_path)
    ...
    crypto_main_path.each do |crypto_price|
      price = crypto_price.xpath('/html/body/div[1]/div[2]/div[2]/div/div[1]/div/div[2]/div[3]/div/table/tbody/tr[1]/td[5]').text
